...
const en = {
  ...
  commercial: {
    total: "Total leads",
    totalCaption: "All captured prospects",
    new: "New leads",
    qualified: "Qualified leads",
    followUp: "Follow-up leads",
    won: "Won leads",
    conversion: "Conversion rate",
    conversionCaption: "Won leads ÷ total leads",
  },
  leadStatus: {
    title: "Leads by status",
    subtitle: "Current commercial pipeline",
  },
  pendingFollowUps: {
    title: "Pending follow-ups",
    subtitle: "Overdue first, then the next scheduled follow-ups",
    viewAll: "View all",
    overdue: "Overdue",
    scheduled: "Scheduled",
    noInterest: "No interest captured",
    empty: "You have no pending follow-ups",
    emptyCopy: "Scheduled follow-ups will appear here.",
  },
  recentLeads: {
    title: "Recent leads",
    subtitle: "Most recently updated prospects",
    viewAll: "View all",
    noConversation: "This lead does not have a linked conversation.",
    noInterest: "No interest captured",
    noBudget: "No budget captured",
    emptyTitle: "No leads yet",
    emptyDescription: "Captured prospects will appear here.",
  },
...
const es: typeof en = {
  ...
  commercial: {
    ...
    totalCaption: "Todos los prospectos capturados",
    new: "Leads nuevos",
    qualified: "Leads calificados",
    followUp: "Leads en seguimiento",
    won: "Leads ganados",
    conversion: "Tasa de conversión",
    conversionCaption: "Leads ganados ÷ total de leads",
  },
  leadStatus: {
    title: "Leads por estado",
    subtitle: "Pipeline comercial actual",
  },
  pendingFollowUps: {
    title: "Seguimientos pendientes",
    subtitle: "Primero los vencidos y luego los próximos programados",
    viewAll: "Ver todos",
    overdue: "Vencido",
    scheduled: "Programado",
    noInterest: "Sin interés registrado",
    empty: "No tienes seguimientos pendientes",
    emptyCopy: "Los seguimientos programados aparecerán aquí.",
  },
  recentLeads: {
    title: "Leads recientes",
    subtitle: "Prospectos actualizados recientemente",
    viewAll: "Ver todos",
    noConversation: "Este lead no tiene una conversación vinculada.",
    noInterest: "Sin interés registrado",
    noBudget: "Sin presupuesto registrado",
    emptyTitle: "Aún no hay leads",
    emptyDescription: "Los prospectos capturados aparecerán aquí.",
  },
